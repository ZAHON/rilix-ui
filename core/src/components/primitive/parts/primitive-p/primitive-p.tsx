 ...
 * text separated from adjacent blocks by blank lines and/or first-line indentation, but HTML paragraphs can
 * be any structural grouping of related content, such as images or form fields.
